...
public class DynamicArrayList {
	...
	/**
	 *
	 * It is a default no argument constructor. Which sets the array length
	 * at 10 for default
	 * 
	 */
	...
	/**
	 *
	 * A parameterised constructor. Of which int size is used as a 
	 * parameter, undergoing a validation check if below 0
	 * IllegalArgumentException is thrown otherwise the arrays size
	 * is selected
	 *
	...
	public String get(int pos) {
		...
		if (pos < 0 || pos >= numElements) {
			throw new IndexOutOfBoundsException("Position must be above zero and the arrays length");
		} else {
			return elements[pos];
		}
	}
	...
	/**
     * Method: add, uses an String value to add to the list
     * 
     * This method checks if there is capacity to add the value
     * if the capacity is equal to the array length, the array length
     * is increased with the grow method, making a slot free to add the value
     * to and increasing the capacity
     *
     * @param: value, the value to be added to the list
     *
     * @return true, indicating the value has been added to the last at the
     * last slot
     *
     */
	...
	/**
	 * Method: set, uses pos of type int as a parameter to retrieve the element in
	...
	public String set(int pos, String value) {
		...
		if (pos >= numElements || pos < 0) {
			throw new IndexOutOfBoundsException("Position must be above zero and below the arrays length");
		}
    ...
    /**
     * 
     * Method: shiftDel, uses parameters array and the position of which
     * to delete from, this method is used in removeAll
     *
     * @param: arr [], the array used to search for the position 
     * @param: pos, the position to be found and replace the value
     *  at the position found
     *
     * @return: isTrue, a boolean indicating whether or not the value was
     * deleted
     *
     */
	...
	/**
	 *
	 * Method: remove, the value is used to search the list if the value exists
	 * and the shiftDel method is performed to deleted the value and the lists
	 * capacity is decreased. This method is used in removeAll
	 *
	 ...
	 * shiftDel methods to delete eachvalue
	 *
	 * @param value a String variable for the value to be removed
	 *
	...
	/**
	 *
	 * Method: contains, which linear searches the array to find the slot containing the
	 * value and returning a boolean isTrue if the value exists
	 *
	 * @param value,  the value which is used to search the array 
	 * 
	 * @return isTrue, indicating whether or not the value exists in the array
	 */
	...
	/**
	 *
	 * Method: isEmpty, checks if the list is empty or not
	 *
	 * @return boolean
	 */
